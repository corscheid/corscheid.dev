  ...
  return (
    <footer>
      ...
      <div className="container">
        <div className="flex">
          <div>
            <a target="_blank" rel="noopener" href="https://github.com/corscheid" title="GitHub">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://stackoverflow.com/users/14083186/corscheid"
              title="StackOverflow"
            >
              <svg
            ...
            <a target="_blank" rel="noopener" href="https://twitter.com/corscheid" title="Twitter">
              <svg className="social-svg" viewBox="0 0 64 64">
                <g className="social-svg-background">
                  <circle cx="32" cy="32" r="31"></circle>
                </g>
            ...
            <a target="_blank" rel="noopener" href="https://keybase.io/corscheid" title="Keybase">
              <svg
                className="social-svg"
                viewBox="-10 -10 45 45"
            ...
            >
              <svg className="social-svg" viewBox="0 0 64 64">
                ...
                <g className="social-svg-background" style={{ fill: "#007fb1" }}>
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://www.facebook.com/corscheid/"
              title="Facebook"
            >
              <svg className="social-svg" viewBox="0 0 64 64">
                <g className="social-svg-background">
