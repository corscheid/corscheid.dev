      ...
      return (
        <>
          ...
          <svg
            ...
            viewBox="-32 0 192 64"
            style={{ backgroundColor: 'var(--nc-tx-2)', fill: 'var(--nc-bg-2)' }}
          >
      ...
      return (
        <>
          ...
          <svg className="social-svg" viewBox="0 0 64 64">
            ...
            <g className="social-svg-background" style={{ fill: 'rgb(29, 161, 242)' }}>
      ...
      return (
        <>
          ...
          <svg className="social-svg" viewBox="0 0 64 64">
            ...
            <g className="social-svg-background" style={{ fill: "#4183c4" }}>
      ...
      return (
        <>
          ...
          <svg className="social-svg" viewBox="0 0 64 64">
            ...
            <g className="social-svg-background" style={{ fill: "#0077B5" }}>
      ...
      return (
        <>
          ...
          <svg className="social-svg" viewBox="0 0 64 64">
            ...
            <g className="social-svg-background" style={{ fill: "#3b5998" }}>
